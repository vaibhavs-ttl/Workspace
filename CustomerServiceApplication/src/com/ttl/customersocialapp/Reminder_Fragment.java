...
public class Reminder_Fragment extends Fragment {
	...
	Spinner spinner_vehicle_no, sipnner_remindertype;
	...
	private String[] remindertype = { "Reminder Type", "Next Service Date",
			...
			"Service Booking", "Tyre Change","Battery Change","24X7 On Road Assistance Renewal" };
	...
	private class DatePickerFragment extends DialogFragment implements
		...
		public void onDateSet(DatePicker view, int year, int month, int day) {
			...
			try {
				...
				Log.d("Date format", getdisplaydate + "");
			} catch (ParseException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	...
	private class MyExpandableListAdapter extends BaseExpandableListAdapter {
		...
		public View getGroupView(int groupPosition, boolean isExpanded,
			...
			}else if (parent.getRemindertitle().equals("24X7 On Road Assistance Renewal")) {
				convertView.findViewById(R.id.imgcomp).setBackgroundResource(
	...
	public int deleteUser(SQLiteDatabase mdb, String deleteMatch,
		...
		try {
			 ...
			 * Reminder.COLUMN_NAME_VEHICLE_REMINDER_DATE + " ='" + deleteMatch
			 * + "' AND " + Reminder.COLUMN_NAME_VEHICLE_REMINDER_TIME + " ='" +
			 * deleteMatch2 + "'", null);
			 */
			int delStatus = mdb.delete(Reminder.TABLE_NAME,
...

	{
		...
		try {
			...
			// Log.d("get current date", dtCurrentDate + "");
...

			{
				if (bundle != null) {
					...
					Log.d("get after time", dtCurrentDate.after(TimeToCompare)
							+ "");
					return false;
					}else {
						Log.d("get after time", dtCurrentDate.after(TimeToCompare)
