    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (!extras.isEmpty()) {
            if (GoogleCloudMessaging.MESSAGE_TYPE_SEND_ERROR
             ...
             /*   try {
                	JSONObject obj = new JSONObject(extras.toString());

					JSONArray array = new JSONArray(extras.toString());
					for(int i=0; i<array.length(); i++)
					{
					JSONObject object = array.getJSONObject(i);
                    Log.d("message aray", object.toString());	
                ...
                /*JSONObject object = (JSONObject) extras.get("message");
                Log.d("message received", object.toString());*/	
