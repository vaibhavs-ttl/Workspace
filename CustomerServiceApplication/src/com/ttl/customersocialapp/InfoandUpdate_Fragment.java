...
public class InfoandUpdate_Fragment extends Fragment {
	...
	Spinner spinner_cityname;
	String[] cityname = { "Head Office(Mumbai)",
			"Regional Office West1 (Mumbai)", "Regional Office West2 (Thane)",
			"Regional Office East (Kolkata)", "Regional Office North1 (Chandigarh)", "Regional Office North2 (Lucknow)", "Regional Office North3 (Gurgaon)",
			"State Office - (K1-Bangalore)", "Regional Office South2 (Chennai)",
			"State Office -  (Mumbai)", "State Office - (Assam & N.E)",
			...
			"State Office - (Orissa- Bhubaneswar)", "State Office - (Jaipur)",
			"State Office - (Ahmedabad)", "State Office - (TN 1-Chennai)",
			"State Office -  (NCR )", "State Office - (Kerala)",
			"State Office - (Telengana-Hyderabad)", "State Office - (Dehradun)",
			"State Office  (AP-Vijaywada)",
			"State Office (Chattisgarh & Vidharbh)",
			"State Office-(West Bengal)", "State Office (TN2-Madurai)",
			"State Office-(Bihar)", "State Office -  (Jharkhand)",
			"State Office- (K2-Hubli)" };
	TextView txtcityname, titlename, address, cellno, cellno1, cellno2, faxno,
			faxno1;
	LinearLayout faxll, faxll1, contactll, contactll1, contactll2,
			btnpdfdwonload;
				...
				.setOnItemSelectedListener(new OnItemSelectedListener() {
					...
					public void onItemSelected(AdapterView<?> parent,
						...
						case 1:
							...
							break;
						case 2:
							txtcityname.setText("Regional Office West2 (Thane)");
							titlename.setText("Tata Motors Ltd");
						...
						case 3:
							txtcityname.setText("Regional Office East (Kolkata)");
							titlename.setText("Tata Motors Ltd");
						...
						case 4:
							txtcityname.setText("Regional Office North1 (Chandigarh)");
							titlename.setText("Tata Motors Ltd");
						...
						case 5:
							txtcityname.setText("Regional Office North2 (Lucknow)");
							titlename.setText("Tata Motors Ltd");
							...
							break;
						case 6:
							txtcityname.setText("Regional Office North3 (Gurgaon)");
							titlename.setText("Tata Motors Ltd");
						...
						case 7:
							txtcityname.setText("State Office - (K1-Bangalore)");
							titlename.setText("Tata Motors Ltd");
							...
							break;
						case 8:
							txtcityname.setText("Regional Office South2 (Chennai)");
							titlename.setText("Tata Motors Ltd");
						...
						case 24:
							txtcityname
									.setText("State Office  (AP-Vijaywada)");
							titlename.setText("Tata Motors Ltd");
