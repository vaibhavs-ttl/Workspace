       ...
       spinregno.setOnItemSelectedListener(new OnItemSelectedListener() {
		...
		//	pl = "Zest XTA QJT 90PS";
			if(!(regnumber.equals("Select Vehicle")))
				...
				if (connect) {
			String req = Config.awsserverurl+"CustomerApp_Restws/customerapp/costEstimateServices/getKms";
	...
	public void calculateCost(String pl , String city , String km)
	{
		...
		if (connect) {
		 List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(3);
			...
			String req = Config.awsserverurl+"CustomerApp_Restws/customerapp/costEstimateServices/getPaidServiceCostEstimate";
