...
<<<<<<< HEAD
	 ...
	 public static class ViewHolder{
         ...
         public TextView dealername,type,date,text_KM,text_contact,text_city,text5,text_amount;
...
//            holder=(ViewHolder)vi.getTag();
        ...
        { 
            ...
            /* if(!(data.get(position).INVOICE_STATUS.equals("Cancelled")))
             {*/
...
//             if(TextUtils.isEmpty(data.get(position).getDEALER_CONTACT_NUMBER())){
//            	 holder.text_contact.setVisibility(View.GONE);
//            //	 holder.text5.setVisibility(View.GONE);
//             }
//             if(TextUtils.isEmpty(data.get(position).getCITY())){
//            	 holder.text_city.setVisibility(View.GONE);
//            //	 holder.text5.setVisibility(View.GONE);
//             }
...
//				 
	...
	private void getComplaintAndJC(String chassis_NO, String sr_HISTORY_NUM, final ViewHolder holder) {
		...
		new WebServiceCall(activity, req1, Constants.GetComplaintAndJCDescripti_CSB, new ResponseCallback() {
			...
			if(complaint_desc.size()>0||complaint_custVoice.size()>0)		{
			holder.tableLayout1.setVisibility(View.VISIBLE);
			BuildTable(complainttext, complaint_desc,complaint_custVoice,holder.tableLayout1);
			}
